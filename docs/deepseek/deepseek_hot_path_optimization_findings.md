...
- **Where:** `candle-transformers/src/models/latent_moe/linear.rs:78-85` (`QLinear::Int8::forward`),
...
improvement at `[1,4,8]` (full path filter `models::latent_moe::wave::tests::test_parallel_batched_forwarding`
