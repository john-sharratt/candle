...
**Validation:** `latent_moe::paged::tests` (22/0, incl. `corpus_cache_two_region_bytes` + prefill↔decode parity), `corpus_cache_is_position_free` (CPU), gallery spill/gather tests, `wave_paris` (3/3) — all green.
