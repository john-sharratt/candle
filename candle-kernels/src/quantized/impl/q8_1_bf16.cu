// =============================================================================
// Q8_1 + BF16 KERNEL INSTANTIATION
// =============================================================================
...
//     q8_1_bf16_s1                      (single batch decode)
//     q8_1_bf16_s8                      (octet batch, 8× weight reuse)
//   Shared memory (transitional):
//     q8_1_bf16_s64, q8_1_bf16_s64_tc   (64-batch, smem weight tiles)
//     q8_1_bf16_s128, q8_1_bf16_s128_tc (128-batch, high-smem HW)
// =============================================================================
