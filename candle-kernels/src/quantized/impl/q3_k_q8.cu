...
//     q3_k_q8_s1                    (single batch decode)
//     q3_k_q8_s8                    (octet batch, 8× weight reuse)
//   Shared memory (transitional):
//     q3_k_q8_s64, q3_k_q8_s64_tc   (64-batch, smem weight tiles)
//     q3_k_q8_s128, q3_k_q8_s128_tc (128-batch, high-smem HW)
//   L2 chunked (compute-bound):
//     q3_k_q8_s64_tc_chunked        (64-batch, L2 pipeline)
//     q3_k_q8_s128_tc_chunked       (128-batch, L2 pipeline)
// =============================================================================
