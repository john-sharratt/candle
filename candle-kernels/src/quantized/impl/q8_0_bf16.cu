// =============================================================================
// Q8_0 + BF16 KERNEL INSTANTIATION
// =============================================================================
...
//     q8_0_bf16_s1                      (single batch decode)
//     q8_0_bf16_s8                      (octet batch, 8× weight reuse)
//   Shared memory (transitional):
//     q8_0_bf16_s64, q8_0_bf16_s64_tc   (64-batch, smem weight tiles)
//     q8_0_bf16_s128, q8_0_bf16_s128_tc (128-batch, high-smem HW)
// =============================================================================
...
// template int marlin::marlin_launch_simple<false, __nv_bfloat16, __nv_bfloat16, __nv_bfloat16, block_c_q8_0>(
//     const __nv_bfloat16*, const int4*, __nv_bfloat16*, const void*, int, int, int, cudaStream_t, int);
// namespace marlin {
// int marlin_q8_0_bf16(const __nv_bfloat16* a, const int4* w, __nv_bfloat16* o, const void* s,
//     int b, int n, int k, cudaStream_t st, int d) {
//     return marlin_launch_simple<false, __nv_bfloat16, __nv_bfloat16, __nv_bfloat16, block_c_q8_0>(a, w, o, s, b, n, k, st, d);
// }}