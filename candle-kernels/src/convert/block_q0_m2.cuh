...
template <> struct BlockInt8<block_q0_m2> {
    static __device__ __forceinline__ Int8Sample load(const block_q0_m2* b, int e) {
        return Int8Sample{ b->centroid[(b->qmask >> (e / 4)) & 1], (1.0f / 127.0f) };
    }
};
