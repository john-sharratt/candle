...
extern "C" void run_paged_prefill_chunks_bf16(
    ...
    #define LAUNCH_BF16(HD, WARPS, TILE) \
        launch_paged_prefill_chunks<__nv_bfloat16, __nv_bfloat16, __nv_bfloat16, HD, WARPS, TILE>( \
    ...
    switch (head_dim) {
        ...
        case 128: LAUNCH_BF16(128, 4, 32); break;
        case 256: LAUNCH_BF16(256, 8, 16); break;
        default: break;
    }
    #undef LAUNCH_BF16
}
