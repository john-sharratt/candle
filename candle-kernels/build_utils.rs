...
const SIMPLE_KERNELS: [&str; 60] = [
    ...
    "src/simple/qsa_score_paged.cu",
    "src/simple/qsa_topk.cu",
    "src/simple/qsa_index_append.cu",
    "src/simple/qsa_page_place.cu",
    ...
    "src/simple/weighted_row_accum.cu",
...
const QUANTIZED_KERNELS: [&str; 46] = [
    ...
    "src/quantized/impl/q3_ko_f32.cu",
