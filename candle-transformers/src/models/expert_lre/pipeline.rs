...
mod fence_ring_tests {
    ...
    fn a_fence_never_replaces_one_from_another_stream() {
        ...
        insert_prefetch_fence(&mut ring, 7, FenceSource::CopyStream, CopyBatchFence::noop());
        ...
        assert!(ring.iter().any(|(l, s, _)| *l == 7 && *s == FenceSource::CopyStream));
        assert!(ring.iter().any(|(l, s, _)| *l == 7 && *s == FenceSource::Streamer));
        assert!(ring.iter().any(|(l, s, _)| *l == 8 && *s == FenceSource::Streamer));
    }
}
