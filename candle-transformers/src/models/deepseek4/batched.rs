...
#[cfg(feature = "cuda")]
use crate::models::batched_layer::{BatchedAttentionLayer, QkvProjection};
#[cfg(feature = "cuda")]
use crate::models::batched_model::BatchedModelCore;
#[cfg(feature = "cuda")]
use crate::models::expert_lre::GpuDispatchTables;
...
use crate::models::profile::{profile_now, ProfileMark};
use crate::models::quantized_matmul::QMatMul;
use crate::models::rope_tables::CisPrecomputations;
...
impl ModelWeights {
    ...
    pub fn from_gguf_by_path_with_int8(
        ...
        #[cfg(feature = "cuda")]
        let used_before_experts = crate::models::batched_model::driver_used_bytes(device);
        ...
        #[cfg(feature = "cuda")]
        let used_after_experts = crate::models::batched_model::driver_used_bytes(device);
...
// The batched-engine integration (and its harness) is CUDA-only; gate the whole test module
// so CPU test builds skip it. The DeepSeek `test_parallel_batched_forwarding` clone lands here.
