...
#[cfg(feature = "cuda")]
pub use region_pool::{
    claim_span_region, initial_weight_bytes, kv_spare_regions, region_stats, set_ground_broker,
    set_weight_floor, span_end, span_layout, span_region_refusal, weight_capacity_bytes,
