...
// use candle_core::gpu_keepalive::GpuKeepalive; // Module not available
...
fn main() -> Result<()> {
    ...
    {
        println!("⚠️  This test requires CUDA features");
        println!("   The gpu_keepalive module is not currently available");
    }
