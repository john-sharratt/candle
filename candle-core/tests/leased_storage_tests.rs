...
//! correctness error rather than a leak. These tests pin the three properties
//! the KV cache relies on: a lease reads the memory it was pointed at, a write
//! through a lease is visible to the owner, and dropping a lease leaves the
//! owner's memory intact.
//!
