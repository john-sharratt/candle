...
impl PinnedBuf {
    ...
    fn alloc_owned_with_flags(len: usize, flags: u32) -> Result<Self> {
        ...
        crate::vram::note_host_pinned_alloc(crate::vram::PinnedUse::Staging, len as u64);
        Ok(Self::Owned {
    ...
    fn drop(&mut self) {
        if let Self::Owned { ptr, len } = self {
            if *len > 0 {
                ...
                crate::vram::note_host_pinned_free(crate::vram::PinnedUse::Staging, *len as u64);
            }
        }
...
impl PinnedArena {
    fn new(capacity: usize) -> Result<Self> {
        ...
        crate::vram::note_host_pinned_alloc(crate::vram::PinnedUse::Staging, capacity as u64);
        Ok(Self {
            ptr: host_ptr as *mut u8,
            dev_ptr,
            capacity,
