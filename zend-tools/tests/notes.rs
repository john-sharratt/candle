...
fn notes_write_empty_content() {
    ...
    let ctx = ctx();
    harness::invoke_with_ctx("notes_write", json!({"key": "empty_key", "content": "data"}), &ctx);
    harness::invoke_with_ctx("notes_write", json!({"key": "empty_key", "content": ""}), &ctx);
...
fn notes_list_with_prefix() {
    let ctx = ctx();
    harness::invoke_with_ctx("notes_write", json!({"key": "proj/a", "content": "1"}), &ctx);
    harness::invoke_with_ctx("notes_write", json!({"key": "proj/b", "content": "2"}), &ctx);
    harness::invoke_with_ctx("notes_write", json!({"key": "other/c", "content": "3"}), &ctx);
    let resp = harness::expect_success(harness::invoke_with_ctx(
        "notes_list",
        json!({"prefix": "proj/"}),
        &ctx,
...
fn notes_write_read() {
    let ctx = ctx();
    let wr = harness::expect_success(harness::invoke_with_ctx("notes_write", json!({
        "key": "mykey",
        "content": "hello notes",
        "tags": ["test"]
    }), &ctx));
    ...
    let rd = harness::expect_success(harness::invoke_with_ctx("notes_read", json!({"key": "mykey"}), &ctx));
...
fn notes_search_by_content() {
    let ctx = ctx();
    harness::invoke_with_ctx("notes_write", json!({"key": "k1", "content": "apples and oranges"}), &ctx);
    harness::invoke_with_ctx("notes_write", json!({"key": "k2", "content": "bananas"}), &ctx);
    let resp = harness::expect_success(harness::invoke_with_ctx("notes_search", json!({
        "query": "apples"
    }), &ctx));
    let results = resp["results"].as_array().unwrap();
    assert_eq!(results.len(), 1);
...
fn notes_list() {
    let ctx = ctx();
    harness::invoke_with_ctx("notes_write", json!({"key": "prefix/a", "content": "1"}), &ctx);
    harness::invoke_with_ctx("notes_write", json!({"key": "prefix/b", "content": "2"}), &ctx);
    harness::invoke_with_ctx("notes_write", json!({"key": "other", "content": "3"}), &ctx);
    let resp = harness::expect_success(harness::invoke_with_ctx("notes_list", json!({"prefix": "prefix/"}), &ctx));
    let notes = resp["notes"].as_array().unwrap();
    assert_eq!(notes.len(), 2);
}
...
fn notes_update() {
    ...
    let wr2 = harness::expect_success(harness::invoke_with_ctx("notes_write", json!({"key": "upd", "content": "v2"}), &ctx));
    assert_eq!(wr2["created"], false);
    let rd = harness::expect_success(harness::invoke_with_ctx("notes_read", json!({"key": "upd"}), &ctx));
