...
fn tool_schema<T: Tool>() -> Value {
    let schema = schemars::gen::SchemaGenerator::default()
        .into_root_schema_for::<T::Request>();
...
use crate::tools::{
    ...
    code::{CODE_RUN, CODE_SESSION_OPEN, CODE_SESSION_EXEC, CODE_SESSION_LIST, CODE_SESSION_CLOSE},
    credentials::{CREDENTIAL_SAVE, CREDENTIAL_LIST, CREDENTIAL_DELETE},
    crypto::{AEAD_ENCRYPT, AEAD_DECRYPT, HMAC_COMPUTE, SIGNATURE_VERIFY, SIGNATURE_SIGN, KDF_DERIVE, HKDF_EXTRACT, HKDF_EXPAND_LABEL},
    datetime::REGISTRATION as DATETIME,
    file::{FILE_WRITE, FILE_READ, FILE_EDIT, FILE_LIST, FILE_DELETE, FILE_PRESENT},
    hash::{HASH_COMPUTE, HASH_SCAN},
    hash_state::{HASH_STATE_INIT, HASH_STATE_UPDATE, HASH_STATE_FINALIZE},
    http_session::{HTTP_SESSION_OPEN, HTTP_SESSION_REQUEST, HTTP_SESSION_LIST, HTTP_SESSION_CLOSE},
    network_diag::{DNS_LOOKUP, PING_ICMP, TRACE_ROUTE, PORT_SCAN, IP_SCAN, HOST_INFO},
    notes::{NOTES_WRITE, NOTES_READ, NOTES_SEARCH, NOTES_LIST},
    random::REGISTRATION as RANDOM,
    remote_fs::{
        REMOTE_FS_SESSION_OPEN, REMOTE_FS_SESSION_LIST_DIR, REMOTE_FS_SESSION_STAT,
        REMOTE_FS_SESSION_GET, REMOTE_FS_SESSION_PUT, REMOTE_FS_SESSION_DELETE,
        REMOTE_FS_SESSION_MKDIR, REMOTE_FS_SESSION_RENAME, REMOTE_FS_SESSION_LIST,
        REMOTE_FS_SESSION_CLOSE,
    },
    sql_session::{SQL_SESSION_OPEN, SQL_SESSION_QUERY, SQL_SESSION_LIST, SQL_SESSION_CLOSE},
    ssh::{SSH_SESSION_OPEN, SSH_SESSION_EXEC, SSH_SESSION_EXEC_ASYNC, SSH_SESSION_POLL, SSH_SESSION_LIST, SSH_SESSION_CLOSE},
    subagent::REGISTRATION as SUBAGENT,
    tcp_session::{TCP_SESSION_OPEN, TCP_SESSION_SEND, TCP_SESSION_RECV, TCP_SESSION_LIST, TCP_SESSION_CLOSE},
    telnet::{TELNET_SESSION_OPEN, TELNET_SESSION_SEND, TELNET_SESSION_LIST, TELNET_SESSION_CLOSE},
    tls_session::{TLS_SESSION_OPEN, TLS_SESSION_SEND, TLS_SESSION_RECV, TLS_SESSION_LIST, TLS_SESSION_CLOSE},
    totp::REGISTRATION as TOTP,
    udp_session::{UDP_SESSION_OPEN, UDP_SESSION_SEND, UDP_SESSION_RECV, UDP_SESSION_LIST, UDP_SESSION_CLOSE},
