...
// Div at indices - parallelizes over indices for sparse updates
kernel void div_at_indices_f32(
...
kernel void div_at_indices_f16(
    constant size_t &num_elements,
    constant size_t &vocab_size,
    constant uint32_t *indices,
    constant size_t &num_indices,
...
kernel void div_at_indices_bf16(
    constant size_t &num_elements,
    constant size_t &vocab_size,
    constant uint32_t *indices,
    constant size_t &num_indices,
