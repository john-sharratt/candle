    ...
    ($name:literal, $at:expr, $cat:literal, $plane:expr, $desc:literal,
     ...
     $situation:literal, $call:literal, $because:literal) => {
        Tool {
            ...
            description: $desc,
            params: &[
                Param { name: $a, ty: "string", required: true, description: $adesc },
                Param { name: $b, ty: "string", required: true, description: $bdesc },
            ],
            examples: &[Example {
                situation: $situation,
                call: $call,
     ...
     $situation:literal, $call:literal, $because:literal) => {
        Tool {
            ...
            params: &[
                Param { name: $a, ty: "string", required: true, description: $adesc },
                Param { name: $b, ty: "string", required: true, description: $bdesc },
                Param { name: $c, ty: "string", required: true, description: $cdesc },
                Param { name: $d, ty: "string", required: true, description: $ddesc },
            ],
            examples: &[Example {
                situation: $situation,
                call: $call,
...
pub const CHRONICLE_ADD_ENTRY: Tool = on_with!(
    "chronicle_add_entry", CHRONICLE, "Chronicle", Plane::World,
    ...
    "to", "The era it belongs under.",
    "what", "What happened, written as the record writes things.",
...
pub const CHRONICLE_REWRITE_PAGE: Tool = on_with!(
    "chronicle_rewrite_page", CHRONICLE, "Chronicle", Plane::World,
    ...
    "in", "The era whose page you are rewriting.",
    "what", "What it should say instead, and why the old wording could not stand.",
...
pub const CHRONICLE_RETIRE_ENTRY: Tool = on!(
...
pub const CHRONICLE_SETTLE_BOUNDARY: Tool = on_with!(
...
pub const STORY_DRAFT: Tool = on_with!(
    "story_draft", STORY_DESK, "Story", Plane::World,
    ...
    "for", "The gap you are filling.",
    "what", "The writing itself: what happened, to whom, and what it cost them.",
...
pub const PORTRAIT_DRAW: Tool = on_with!(
    "portrait_draw", EASEL, "Portrait", Plane::World,
    ...
    "of", "Who it is a likeness of.",
    "carrying", "What the face has to show: what they have been through, and what they hide.",
...
pub const PORTRAIT_PROMPT_READ: Tool = on!(
...
pub const PORTRAIT_PROMPT_EDIT: Tool = on_with!(
    "portrait_prompt_edit", EASEL, "Portrait", Plane::World,
    ...
    "of", "Whose likeness — the personality it belongs to, by its id.",
    "carrying", "What the face has to show now, whole. This replaces the art direction rather \
     than adding to it.",
...
pub const LIBRARY_READ: Tool = on_with!(
...
pub const LIBRARY_WRITE: Tool = on_with4!(
    "library_write", CRAFT, "Craft", Plane::World,
    "Change one field of a mood or a response. **This changes how every character in the world \
     ...
     you commit it.",
    "kind", "Which library — `mood` or `response`.",
    "id", "Which piece, by its id.",
    "field", "Which part: `description` (the one line that says what it is for) or `template` \
     (the register itself).",
    "text", "What it says now, whole.",
...
pub const PORTRAIT_SETTLE_LIKENESS: Tool = on_with!(
...
pub const PORTRAIT_FILE_PLATE: Tool = on!(
...
pub const CHARACTER_WRITE_IDENTITY: Tool = on_with!(
    "character_write_identity", CHARACTER, "Casting", Plane::World,
    ...
    "of", "The character you are holding.",
    "what", "Who they are: manner, bearing, and what they take for granted.",
...
pub const CHARACTER_WRITE_WANTS: Tool = on_with!(
    "character_write_wants", CHARACTER, "Casting", Plane::World,
    ...
    "of", "The character you are holding.",
    "what", "What they are after, and what it costs them to want it.",
...
pub const CHARACTER_WRITE_MEMORIES: Tool = on_with!(
    "character_write_memories", CHARACTER, "Casting", Plane::World,
    ...
    "of", "The character you are holding.",
    "what", "What happened, and what it left them with.",
...
pub const CHARACTER_SETTLE_RELATION: Tool = on_with!(
...
pub const PLACE_WRITE_ENTRY: Tool = on_with!(
    "place_write_entry", SURVEY, "Cartography", Plane::World,
    ...
    "of", "The place you are holding.",
    "what", "What it is, and what being there is like.",
...
pub const PLACE_WRITE_LOCAL_HISTORY: Tool = on_with!(
    "place_write_local_history", SURVEY, "Cartography", Plane::World,
    "Write the history of one place, so it explains something the wider record only asserts.",
    "of", "The place you are holding.",
    "what", "What happened here, and what it explains.",
...
pub const PLACE_SETTLE_ROUTE: Tool = on_with!(
    "place_settle_route", ROAD, "Cartography", Plane::World,
    "Agree with somebody how two places connect, so neither entry lies about the journey.",
    "from", "The place you hold, at your end of the route.",
    "to", "The place they hold, at the other end of it.",
...
pub const MAP_ADD_PLACE: Tool = on_with!(
    "map_add_place", MAP_TABLE, "Cartography", Plane::World,
    "Put a new place into the world, and make the places around it still make sense.",
    "called", "What it is called, as everybody else will have to refer to it.",
    "where", "What it sits between, and what that does to its neighbours.",
...
pub const MAP_REMOVE_PLACE: Tool = on!(
...
pub const RECORD_ACCESSION: Tool = on_with!(
    "record_accession", ACCESSION, "Custody", Plane::World,
    ...
    "what", "What has come in, by whatever it is going to be called from now on.",
    "from", "Where it came from, and how much of what it says about itself you believe.",
...
pub const RECORD_WRITE_PROVENANCE: Tool = on_with!(
    "record_write_provenance", ACCESSION, "Custody", Plane::World,
    "Write down where something came from, for a thing already in daily use whose origin nobody \
     can state.",
    "of", "The thing in question.",
    "from", "What is actually known about where it came from — including that little is.",
...
pub const RECORD_HAND_ON: Tool = on_with!(
...
pub const RECORD_APPRAISE: Tool = on_with!(
    "record_appraise", APPRAISAL, "Appraisal", Plane::World,
    ...
    "what", "What you are weighing.",
    "verdict", "What you think it is worth keeping for, or why it is not.",
...
pub const RECORD_WRITE_REASON: Tool = on_with!(
    "record_write_reason", APPRAISAL, "Appraisal", Plane::World,
    ...
    "about", "What was let go, and now needs its reasoning written down.",
    "why", "The reasoning, in enough detail to be wrong.",
...
pub const RECORD_LET_GO: Tool = on_with!(
    "record_let_go", APPRAISAL, "Appraisal", Plane::World,
    "Refuse to keep something. It leaves the record, and the reason you give goes with it.",
    "what", "What you are letting go.",
    "because", "Why. Without this the act is not available — a thing let go for no stated reason \
...
pub const RECORD_DESCRIBE: Tool = on_with!(
    "record_describe", CATALOGUE, "Description", Plane::World,
    "Write the way in to a body of work, for somebody who does not yet know what they are \
     looking for. Not the work — the door.",
    "what", "What you are describing.",
    "how", "The way in, in the words somebody would search with rather than the ones you used \
     while making it.",
...
pub const RECORD_ARRANGE: Tool = on_with!(
    "record_arrange", CATALOGUE, "Description", Plane::World,
    "Put a thing where the person who needs it would look for it — the order that makes the \
     fewest people ask where something is.",
    "what", "What you are arranging.",
    "under", "Where it should sit, and why that is where somebody would look.",
...
pub const RECORD_CROSS_REFERENCE: Tool = on_with!(
    "record_cross_reference", CATALOGUE, "Description", Plane::World,
    "Point one part of the record at another that bears on it. Work nobody can find is work \
     nobody did.",
    "from", "The thing that should point.",
    "to", "What it should point at.",
...
pub const RECORD_LEAVE_NOTE: Tool = on_with!(
    "record_leave_note", CATALOGUE, "Description", Plane::World,
    "Leave a note for whoever picks this up next — what you were in the middle of, and what you \
     would have done tomorrow.",
    "on", "What the note is about.",
    "what", "What the next person needs to know.",
...
pub const RECORD_TIDY_INDEX: Tool = on!(
    "record_tidy_index", CATALOGUE, "Description", Plane::World,
    "Bring an index back to what it actually indexes, when the two have drifted.",
    "what", "The thing whose index entry no longer says what it is.",
...
pub const RECORD_MEND: Tool = on_with!(
    "record_mend", MENDING, "Condition", Plane::World,
    "Repair something that has gone wrong with age — an entry true when it was written and \
     quietly wrong now.",
    "what", "What you are mending.",
    "how", "What you changed, and what it said before.",
...
pub const RECORD_MARK_REPAIR: Tool = on!(
    "record_mark_repair", MENDING, "Condition", Plane::World,
    ...
    "what", "What you repaired, and whose mend should stay visible.",
...
pub const ENQUIRY_TAKE_QUESTION: Tool = on!(
...
pub const ENQUIRY_ANSWER_FROM_RECORD: Tool = on_with!(
    "enquiry_answer_from_record", ENQUIRY, "Service", Plane::World,
    ...
    "what", "The enquiry you are answering.",
    "answer", "What the record says, and where it stops.",
...
pub const ENQUIRY_NAME_THE_GAP: Tool = on_with!(
    "enquiry_name_the_gap", ENQUIRY, "Service", Plane::World,
    ...
    "what", "The enquiry the record cannot answer as it stands.",
    "missing", "What would have to exist for it to be answerable.",
...
pub const ENQUIRY_RAISE_WORK: Tool = on_with!(
    "enquiry_raise_work", ENQUIRY, "Service", Plane::World,
    "Turn a question you could not answer into a piece of work somebody could take.",
    "from", "The enquiry it came out of.",
    "work", "What somebody would actually have to do.",
...
pub const ORDERS_SET: Tool = on_with!(
...
pub const ORDERS_HAND_TO: Tool = on_with!(
...
pub const ORDERS_REPORT_DONE: Tool = on!(
    "orders_report_done", ORDERS, "Command", Plane::World,
    "Report an order you were holding as finished, to whoever set it.",
    "what", "The order you have finished.",
...
pub const DISPATCH_POST_WAKE: Tool = on_with!(
    "dispatch_post_wake", DISPATCH, "Command", Plane::World,
    "Post what your change has broken, so the people whose work it breaks find out from you \
     rather than from the breakage.",
    "from", "The change you made.",
    "breaks", "What now needs repairing, and whose it is.",
...
pub const CAST_REPORT_DISAGREEMENT: Tool = on_with!(
    "cast_report_disagreement", WATCH, "Casting", Plane::World,
    "Report something across the cast that does not fit — and it is not yours to correct, which \
     is the point of reporting it.",
    "about", "Who or what does not fit.",
    "what", "What the disagreement actually is.",
...
pub const CREATOR_PRESENT: Tool = on!(
...
pub const PLANT_NOTE_DRIFT: Tool = on_with!(
    "plant_note_drift", PLANT, "Plant", Plane::World,
    "Note a reading that has been slightly wrong for a while. In a place that runs itself the \
     danger is not failure, it is drift.",
    "what", "The reading that has moved, by the name on the panel.",
    "drift", "What it should be, and how long you think it has been off.",
...
pub const PLANT_RAISE_FAULT: Tool = on_with!(
    "plant_raise_fault", PLANT, "Plant", Plane::World,
    "Raise a fault nobody else thinks is a fault, and be prepared to be wrong in public.",
    "what", "What you think is wrong.",
    "why", "Why you think so, given nobody else does.",
...
pub const STORES_TAKE_OUT: Tool = on!(
...
pub const STRUCTURE_LAY_OUT_SCENES: Tool = on!(
...
pub const STRUCTURE_TEST_THE_WANT: Tool = on_with!(
...
pub const STRUCTURE_FIND_THE_SLACK: Tool = on!(
    "structure_find_the_slack", STRUCTURE, "Structure", Plane::World,
    "Find where a piece stops being a chain of consequences and becomes a list of events.",
    "what", "The piece you are reading for slack.",
...
pub const GATHER_CALL: Tool = on_with!(
    "gather_call", READING_TABLE, "Gathering", Plane::World,
    "Call everybody whose work touches a thing that concerns all of them, and say what it is \
     about.",
    "about", "What the gathering is for.",
    "who", "Whose work it touches.",
